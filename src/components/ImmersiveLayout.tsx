        ...
        <div className="relative w-full h-screen overflow-hidden flex bg-black">
            ...
            >
                <div className="p-4 border-b flex items-center gap-2 border-white/10">
                    ...
                    <input
                        ...
                        className="bg-transparent border-none outline-none w-full placeholder-gray-500 font-mono text-sm text-white"
                    />
                </div>
            ...
            >
                <div className="p-4 border-b flex items-center justify-between border-white/10">
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded-full text-gray-500 bg-white/5">
                        {cities.length}
                    </span>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
                    ...
                    {cities.length === 0 && (
                        <div className="flex flex-col items-center justify-center h-full text-center p-8 space-y-4 opacity-30">
                            ...
                            <div className="text-xs uppercase tracking-widest text-gray-500">No systems tracked</div>
                        </div>
                    )}
                </div>
