    ...
    return (
        ...
        >
            <Link to="/" className="flex items-center gap-2 group">
                ...
                <span className="text-xl font-display font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-100 dark:to-gray-400 tracking-wider text-white">
                    CHRONOSPHERE
                </span>
            </Link>
