...
export function About() {
    ...
    return (
        <div className="space-y-12 max-w-4xl mx-auto text-center mt-8">
            <div className="space-y-4">
                <h1 className="text-5xl font-display font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-100 dark:to-gray-400">
                    About ChronoSphere
                </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {stacks.map((item) => (
                    <div key={item.label} className="p-6 bg-white/5 border border-white/10 rounded-2xl flex flex-col items-center gap-4 hover:bg-white/10 transition">
                        <div className="p-4 bg-gray-500/10 rounded-full text-gray-700 dark:text-gray-300">
                            <item.icon size={32} />
                        </div>
