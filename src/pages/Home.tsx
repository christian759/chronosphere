        ...
        <div className="space-y-20">
            ...
            <section>
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h2 className="text-3xl font-display font-bold text-gray-900 dark:text-white mb-2">Tracked Systems</h2>
                        <p className="text-gray-600 dark:text-gray-400">Monitoring global temporal nodes</p>
                    </div>
