        ...
        <div className="space-y-16">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                    ...
                    >
                        <h1 className="text-6xl md:text-8xl font-display font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mb-6 drop-shadow-lg">
                            TIME <br />
                            REIMAGINED
                        </h1>
                        ...
                        <div className="flex gap-4">
                            <Link to="/globe" className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-medium transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] flex items-center gap-2">
            ...
            <section>
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Link to="/favorites" className="text-blue-500 hover:text-blue-400 text-sm font-medium">View All Cities</Link>
                </div>
